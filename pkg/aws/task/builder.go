...
func (b *Builder) CreateDBCluster(user, host, clusterName, clusterType string) *Builder {
...
func (b *Builder) CreateDBParameterGroup(user, host, clusterName, clusterType string) *Builder {

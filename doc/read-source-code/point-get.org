...
** Convert AST to logic plan
    #+BEGIN_SRC plantuml :file ./png/point_get_logical_plan.png
@startyaml
core.PointGetPlan:
  dbName: test
  schema(*expression.Schema):
    Columns([]*expression.Column):
      -
        RetType(*types.FieldType): to add
        ID: 1
        UniqueID: 0
        Index: 0                                                                                               
        hashcode([]uint8): nil                                                                                 
        VirtualExpr(expression.Expression): nil
        OrigName: col01
        IsHidden: false
        IsPrefix: false
        InOperand: false
        collationInfo(expression.collationInfo): 
          coer:0                                                                                              
      ...
      -
        ...
        collationInfo(expression.collationInfo): 
          ...
          collation: -
        CorrelatedColUniqueID: 0
    Keys([]expression.KeyInfo): nil
    UniqueKeys([]expression.KeyInfo): nil
  TblInfo(*model.TableInfo): to add
  IndexInfo(*model.IndexInfo): nil
  PartitionInfo(*model.PartitionDefinition): nil
  Handle: 1
  HandleConstant(*expression.Constant): nil
  handleFieldType(*types.FieldType): to add
  IndexValues([]types.Datum): nil
  IndexConstants([]*expression.Constant): nil
  ColsFieldType([]*types.FieldType): nil
  IdxCols([]*expression.Column): nil
  IdxColLens([]int): nil
  AccessConditions([]expression.Expression): nil
  ctx(sessionctx.Context): nil
  ...
  outputNames([]*types.FieldName):
    ...
    -
      types.FieldName:
        ...
        Redundant: false
  LockWaitTime: 0
  partitionColumnPos: 0
  Columns([]*model.ColumnInfo): nil
  cost: 0                                                                                               
  planCostInit: false                                                                                   
  planCost: 0                                                                                           
  planCostVer2(core.costVer2):
    cost: 0
    trace(*core.costTrace): nil
  accessCols([]*expression.Column): nil                                                                  
  probeParents([]core.PhysicalPlan): nil
  stmtHints(*stmtctx.StmtHints): nil
@endyaml
    #+END_SRC

...
func newPG2Kafka2TiDBDeploy() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.TiDB2Kafka2PgDeploy(clusterName, "ohmytiup-tidb2kafka2pg", topoFile, opt, gOpt)
		},
	}
...
func newListPG2Kafka2TiDBCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.ListTiDB2Kafka2PgCluster(clusterName, "ohmytiup-tidb2kafka2pg", opt)
		},
	}
...
You can retain some nodes and roles data when destroy cluster, eg:
  ...
  $ tiup cluster destroy <cluster-name> --retain-node-data 172.16.13.12`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.DestroyTiDB2Kafka2PgCluster(clusterName, "ohmytiup-tidb2kafka2pg", gOpt, destroyOpt, skipConfirm)
		},
	}
...
func newPerfPreparePG2Kafka2TiDB() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.PerfPreparePG2Kafka2TiDB(clusterName, "ohmytiup-tidb2kafka2pg", perfOpt, gOpt)
		},
	}

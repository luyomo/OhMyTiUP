...
func newTiDB2Msk2RedshiftCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "tidb2msk2redshift <sub_command>",
		Short: "Run commands for syncing the data to redshift from tidb through msk",
	}

	cmd.AddCommand(
		newTiDB2Msk2RedshiftDeploy(),
		newListTiDB2Msk2RedshiftCmd(),
		newDestroyTiDB2Msk2RedshiftCmd(),
		newTiDB2Msk2RedshiftPerfCmd(),
	)
	return cmd
}

func newTiDB2Msk2RedshiftPerfCmd() *cobra.Command {
	cmd := &cobra.Command{
...
func newTiDB2Msk2RedshiftDeploy() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.TiDB2Msk2RedshiftDeploy(clusterName, TiDB2MSK2REDSHIFT, topoFile, opt, gOpt)
		},
	}
...
func newListTiDB2Msk2RedshiftCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.ListTiDB2Msk2RedshiftCluster(clusterName, TiDB2MSK2REDSHIFT, opt)
		},
	}
...
func newDestroyTiDB2Msk2RedshiftCmd() *cobra.Command {
...
You can retain some nodes and roles data when destroy cluster, eg:
  ...
  $ tiup cluster destroy <cluster-name> --retain-node-data 172.16.13.12`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.DestroyTiDB2Msk2RedshiftCluster(clusterName, TiDB2MSK2REDSHIFT, gOpt, destroyOpt, skipConfirm)
		},
	}

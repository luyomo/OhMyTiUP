...
func newTiDB2Kafka2PgDeploy() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.TiDB2Kafka2PgDeploy(clusterName, topoFile, opt, gOpt)
		},
	}
...
func newListTiDB2Kafka2PgCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.ListTiDB2Kafka2PgCluster(clusterName, opt)
		},
	}
...
You can retain some nodes and roles data when destroy cluster, eg:
  ...
  $ tiup cluster destroy <cluster-name> --retain-node-data 172.16.13.12`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.DestroyTiDB2Kafka2PgCluster(clusterName, gOpt, destroyOpt, skipConfirm)
		},
	}
...
func newPerfPrepareTiDB2Kafka2Pg() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.PerfPrepareTiDB2Kafka2PG(clusterName, perfOpt, gOpt)
		},
	}
...
func newPerfCleanTiDB2Kafka2Pg() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cm.PerfCleanTiDB2Kafka2PG(clusterName, gOpt)
		},
	}

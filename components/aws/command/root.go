...
import (
	...
	tiupmeta "github.com/luyomo/OhMyTiUP/pkg/environment"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar((*string)(&gOpt.IdentityFile), "identity-file", "", "The identity file for natijve ssh")
	rootCmd.PersistentFlags().StringVar((*string)(&gOpt.SSHUser), "ssh-user", "", "The user for native ssh")
	...
	rootCmd.AddCommand(
		...
		newTiDB2Kafka2PgCmd(),
		newTiDB2Kafka2ESCmd(),
		newTiDB2Kafka2RedshiftCmd(),
		newTiDB2Msk2RedshiftCmd(),
		newPG2Kafka2TiDBCmd(),
		newTiDB2S3DeltaLakeCmd(),
